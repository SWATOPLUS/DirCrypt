...
namespace DirCrypt.Crypt
{
    class Aes
    {
        ...
        private static uint LittleEndianToUInt32(byte[] buffer)
        {
        ...
        private static uint LittleEndianToUInt32(byte[] buffer, int offset)
        {
        ...
        private static void UInt32ToLittleEndian(uint number, byte[] buffer, int offset)
        {
